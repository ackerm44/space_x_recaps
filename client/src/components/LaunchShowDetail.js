    ...
    return (
      <div className="launchShow">
        <div className="launchDetail">
          ...
          <h3><DateFormat date={props.launch.date_utc}/></h3>
          ...
          <p><a href={props.launch.links.article} target="_blank">More Information</a></p>
          <a href={props.launch.links.webcast} target="_blank">Video of Launch</a>
        </div>
